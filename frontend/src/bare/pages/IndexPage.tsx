...
const SEED_ACCOUNTS: Array<[string, string, string]> = [
  ["대표", "01000000001", "한종철 — 전권"],
  ["관리자", "01000000002", "김관리 — 관리자 프리셋"],
  ["조교", "01000000003", "박조교 — 워크북업로드·클리닉배정"],
  ["학생", "01010000001 ~ 01010000030", "30명(29·30번은 예비등록)"],
  ["학부모", "01020000001 ~ 01020000010", "10명(자녀 1~2명 연동)"],
];
