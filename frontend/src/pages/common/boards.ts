...
/** 게시판마다 "여기가 무엇을 하는 곳인지" 한 줄. PageHeader 설명에 쓴다. */
export const BOARD_INTRO: Record<BoardCategory, string> = {
  공지사항: "수업·일정·운영 안내입니다. 주차 공지는 해당 주차가 함께 표시됩니다.",
  질답: "교재·수업 내용에 대해 물어보면 강사와 조교가 댓글로 답해 드립니다.",
  정오표: "교재와 시험지에서 바로잡은 내용을 모았습니다.",
  자유게시판: "한종철 선생님이 짧게 남기는 글입니다.",
  이벤트굿즈: "학원 이벤트와 굿즈 소식입니다. 원하는 굿즈는 댓글로 알려 주세요.",
};

/** 글이 하나도 없을 때의 문구 — "데이터 없음" 대신 왜 비었는지 쓴다. */
