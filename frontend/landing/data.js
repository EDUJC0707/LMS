...
/* 히어로 배경 후보. 사용자가 한 장씩 준다(2026-07-29) — 여기 줄만 추가하면
   디버그 패널(⌘⌥D)의 **배경** 그룹에 바로 뜬다.
   비어 있어도 된다: 그때는 검정이고, 지금까지와 같다.
   파일은 assets/space/ 에 둔다. 패널의 "파일 열기" 로는 코드를 안 고치고도
   아무 이미지나 즉석에서 볼 수 있다(고를 때까지는 그게 빠르다). */
export const SPACE = [
  // { key: 'nebula', label: '성운', src: 'assets/space/nebula.webp' },
];
